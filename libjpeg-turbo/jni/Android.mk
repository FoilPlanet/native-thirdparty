...
LOCAL_CFLAGS += -DBUILD="20141110"

# SOURCE_PATH := libjpeg-turbo-1.5.3
# LOCAL_CFLAGS += -DPACKAGE_NAME="\"libjpeg-turbo\"" -DVERSION="\"1.5.3\"" -DBUILD="\"20200130\""
...
# ASMFLAGS for NASM/YASM (x86), and ASFLAGS for Clang Assembeller
LOCAL_ASMFLAGS += -DELF
LOCAL_ASFLAGS  += -DELF
...
else ifneq ($(filter $(TARGET_ARCH_ABI), arm64-v8a armv8-a),)
LOCAL_SRC_FILES += \
...
# xiaofeng: jsimd_arm64_neon.S does not compile with Clang
